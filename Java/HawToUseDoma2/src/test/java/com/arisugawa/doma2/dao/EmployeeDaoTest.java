...
public class EmployeeDaoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        url = "jdbc:postgresql://localhost:5432/general?currentSchema=testschema";
        user = "testrole";
        password = "testrole";
    }
    ...
    public void testSelectById() throws Exception {
        SqlFile sqlFile = repository.getSqlFile(getMethod(), "META-INF/com/arisugawa/doma2/dao/EmployeeDao/selectById.sql", dialect);
        execute(sqlFile);
    }
